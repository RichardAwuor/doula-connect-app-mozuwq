...
export default function PaymentScreen() {
  console.log('[Payment Native] Screen mounted - SIMULATED MODE');
  ...
  const handleSimulatedPayment = async () => {
    console.log('[Payment Native] Starting simulated payment process...');
    ...
    try {
      ...
      console.log('[Payment Native] Subscription marked as active in local storage');
      
      console.log('[Payment Native] Simulated payment successful!');
      ...
      console.error('[Payment Native] Error during simulated payment:', error);
      Alert.alert(
        'Error',
  ...
  const handleSkipPayment = () => {
    console.log('[Payment Native] User chose to skip payment');
    Alert.alert(
      'Skip Payment',
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              const AsyncStorage = (await import('@react-native-async-storage/async-storage')).default;
              await AsyncStorage.setItem('doula_connect_subscription_active', 'true');
              console.log('[Payment Native] Subscription marked as active (skipped payment)');
              
              router.replace('/(tabs)/connect');
            } catch (error: any) {
              console.error('[Payment Native] Error skipping payment:', error);
