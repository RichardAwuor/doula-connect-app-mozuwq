  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await apiPost('/api/payments/create-payment-intent', {
        ...
        amount: subscriptionFee * 100, // Convert to cents
      ...
      if (initError) {
        console.error('[Payment] Error initializing payment sheet:', initError);
      ...
      if (presentError) {
        console.error('[Payment] Error presenting payment sheet:', presentError);
